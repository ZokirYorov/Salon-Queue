        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div class="p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4 border-b border-slate-200 dark:border-slate-700">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <button type="button" @click="openBusinessApp" class="rounded-xl cursor-pointer bg-teal-600 px-3 py-2 text-xs font-black text-white transition hover:bg-teal-700">
                Biznes yaratish
              </button>
            </div>
          </div>
