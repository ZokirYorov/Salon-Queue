<template>
  <div class="space-y-6">
    ...
    <div v-else-if="bookings.length === 0" class="rounded-3xl border border-dashed border-slate-200 bg-white py-16 text-center dark:border-slate-700 dark:bg-slate-800">
      ...
      <RouterLink to="/businesses" class="mt-3 inline-block text-sm font-black text-teal-600 transition hover:underline dark:text-teal-300">Salon topish</RouterLink>
    </div>
