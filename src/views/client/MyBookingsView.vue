        ...
        >
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              class="text-xs cursor-pointer font-semibold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 px-2.5 py-1 rounded-lg transition"
            >
              Bekor qilish
            </button>
          </div>
    ...
    <div
      ...
      <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 max-w-sm w-full shadow-xl space-y-4">
        ...
        <div class="grid grid-cols-2 gap-2">
          <button @click="cancelTarget = null" class="text-sm cursor-pointer font-semibold text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg py-2 transition">Yo'q</button>
          <button @click="confirmCancel" :disabled="cancelling" class="text-sm cursor-pointer font-semibold text-white bg-red-600 hover:bg-red-700 rounded-lg py-2 transition disabled:opacity-60">
